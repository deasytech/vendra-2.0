    ...
    <div class="invoice-container">
        ...
        <div class="header">
            <div class="logo-section">
                @if (isset($invoice->organization->logo) && $invoice->organization->logo)
                    <img src="{{ $invoice->organization->logo }}" alt="Logo"
                        style="max-height: 60px; margin-bottom: 10px;">
                @else
                    <div class="company-name">{{ $invoice->organization->legal_name ?? 'Your Company' }}</div>
                @endif
