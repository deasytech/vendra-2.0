<div class="max-w-6xl mx-auto p-6" x-data="{
                            ...
                            <select wire:model.live="invoice_lines.{{ $idx }}.product_id"
                                ...
                                @foreach ($this->products as $product)
                                    <option value="{{ $product->id }}">
                                        {{ $product->name }} - {{ $product->currency_code }}
    ...
    <div class="flex flex-wrap gap-4 justify-end">
        <button @click.prevent="runAction('saveAsDraft')" wire:loading.attr="disabled" wire:target="saveAsDraft"
        ...
        <button @click.prevent="runAction('submitInvoice')" wire:loading.attr="disabled" wire:target="submitInvoice"
