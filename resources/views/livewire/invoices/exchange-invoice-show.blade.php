<section class="w-full">
    ...
    <div
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {{-- Supplier Card (For Exchange Invoices - This is the party that sent the invoice) --}}
            <div
                ...
                <div class="flex items-center space-x-4 mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-zinc-500 dark:text-zinc-400">Invoice From (Exchange Sender)</p>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    <div
                        ...
                        <h4 class="font-bold text-lg text-zinc-800 dark:text-zinc-100 mb-2">
                            {{ data_get($invoice->accounting_supplier_party, 'party_name', '-') }}
                        </h4>
                    ...
                    @php
                        $supplierAddress = data_get($invoice->accounting_supplier_party, 'postal_address', []);
                    @endphp
                    @if (!empty($supplierAddress['street_name']) || !empty($supplierAddress['city_name']))
                        <div
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div class="text-sm">
                                    <p class="font-medium text-emerald-800 dark:text-emerald-200 mb-1">Supplier Address
                                    </p>
                                    <p class="text-emerald-700 dark:text-emerald-300">
                                        {{ $supplierAddress['street_name'] ?? '' }}<br>
                                        {{ $supplierAddress['city_name'] ?? '' }}
                                        {{ $supplierAddress['postal_zone'] ?? '' }}<br>
                                        {{ $supplierAddress['state_name'] ?? '' }}
            ...
            {{-- Customer Card (For Exchange Invoices - This is your organization) --}}
            <div
                class="bg-gradient-to-br from-zinc-50 to-white dark:from-zinc-800/60 dark:to-zinc-900/40 rounded-2xl p-8 border border-zinc-200 dark:border-zinc-700/50 shadow-lg backdrop-blur-sm">
                <div class="flex items-center space-x-4 mb-6">
                    <div
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-zinc-800 dark:text-zinc-100">Recipient (Your Organization)
                        </h3>
                    ...
                    @if (!empty($orgAddress['street_name']) || !empty($orgAddress['city_name']))
                        <div
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div class="text-sm">
                                    <p class="font-medium text-blue-800 dark:text-blue-200 mb-1">Business Address
                                    </p>
                                ...
                                $linePrice =
                                    (float) ($item->unit_price ??
                                        ($item->price['price_amount'] ??
                                            ($linePrice ?? ($item->item['unit_price'] ?? 0))));
                ...
                @if ($qrDataUri)
                    <div
                        ...
                        <div class="flex justify-center">
                            <img src="{{ $qrDataUri }}" alt="NRS QR Code" title="NRS QR Code"
