<div class="max-w-4xl mx-auto p-6">
    ...
    <div class="bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl shadow-lg p-6 mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-white mb-2">Create Customer</h1>
                <p class="text-purple-100">Add a new customer to your database</p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-lg p-6">
        <form wire:submit.prevent="save">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Customer Name <span
                ...
                <div class="md:col-span-2">
                    <label for="street_name" class="block text-sm font-medium text-gray-700 mb-2">Street Address <span
                            class="text-red-500">*</span></label>
                ...
                <div>
                    <label for="city_name" class="block text-sm font-medium text-gray-700 mb-2">City <span
                            class="text-red-500">*</span></label>
                ...
                <div>
                    <label for="postal_zone" class="block text-sm font-medium text-gray-700 mb-2">Postal Code <span
                            class="text-red-500">*</span></label>
