<div class="max-w-7xl mx-auto p-6">
    ...
    <div class="bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl shadow-lg p-6 mb-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-purple-100">Manage your customer relationships</p>
            </div>
            <div class="flex items-center space-x-4">
                <div class="text-white text-right">
                    <div class="text-sm opacity-75">Total Customers</div>
                    <div class="text-2xl font-bold">{{ $customers->total() }}</div>
                </div>
                <a href="{{ route('customers.create') }}"
                    class="bg-white text-purple-600 px-4 py-2 rounded-lg font-medium hover:bg-gray-100 transition-colors flex items-center">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white rounded-xl shadow-lg p-4 border-l-4 border-green-500">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600">With TIN</p>
                    <p class="text-2xl font-bold text-gray-800">{{ $customers->whereNotNull('tin')->count() }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-4 border-l-4 border-yellow-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800">{{ $customers->whereNotNull('email')->count() }}</p>
                </div>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800">
                        {{ $customers->where('created_at', '>=', now()->subDays(30))->count() }}</p>
                </div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <div class="text-sm text-gray-500">{{ $customer->legal_name ?? '' }}</div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900 font-mono">{{ $customer->tin ?? 'N/A' }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
