            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="flex items-center space-x-4">
                        @if ($existing_logo)
                            <div class="relative">
                                <img src="{{ Storage::url($existing_logo) }}" alt="Customer Logo"
                                    class="h-24 w-24 rounded-lg object-cover border-2 border-gray-200">
                                <button type="button" wire:click="removeLogo"
                                    class="absolute -top-2 -right-2 bg-red-600 text-white rounded-full p-1 hover:bg-red-700 transition-colors shadow-md">
                ...
                <div class="md:col-span-2">
                    <label for="street_name" class="block text-sm font-medium text-gray-700 mb-2">Street
                        Address</label>
